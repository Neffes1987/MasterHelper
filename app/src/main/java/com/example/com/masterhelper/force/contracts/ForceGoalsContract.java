...
public class ForceGoalsContract implements BaseColumns {

  private final static String relationTable = GoalContract.TABLE_NAME;
  private final static String relationId = GoalContract._ID;

  public final static String TABLE_NAME = "force_goal_settings";

  public final static String COLUMN_FORCE_ID = "forceId";
  public final static String COLUMN_RELATION_ID = "goalId";
  ...
  public String[] getValues(DataModel newItem, int forceId){
    ...
    return new String[]{ forceId + "", model.getId() + "", model.getResolveResult(), model.getRejectResult()};
  }
}
